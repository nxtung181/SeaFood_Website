...
public class ImageUpload {
    private String UPLOAD_FILE = "D:\\project spring\\Ecommerce-Springboot\\Admin\\src\\main\\resources\\static\\img\\img-products";
    ...
    public boolean checkExist(MultipartFile multipartFile){
        ...
        try{
            File file = new File(UPLOAD_FILE + "\\" + multipartFile.getOriginalFilename());
            isExist = file.exists();
        }catch (Exception e){
            e.printStackTrace();
        }
